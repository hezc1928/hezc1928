...
private:
    ...
    bool randNew()
    {
        ...
        // 10%的概率产生4
        data[value / N][value % N] = rand() % 10 == 1 ? 4 : 2048;
        return true;
    }
...
// g++ 2048.cpp E:\cpp_project\resource\pdcurs36\wincon\pdcurses.a -I E:\cpp_project\Stanford\2048-3 -o 2048
// g++ 2048.cpp pdcurses.a -I E:\cpp_project\Stanford\2048-3 -o 2048
// 用上面这个编译，然后出去运行exe
// 修改各项输出文字
// 修改数字的颜色
// 增加计分功能
